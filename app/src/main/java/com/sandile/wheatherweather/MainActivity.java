...
//                finish();//This is to close activity
    ...
    private void SearchCityApi() {
        final String tempCitySearchText = AccuCityTextBuilder();
        Log.d("city_search", tempCitySearchText);
        Call<List<RootAccuCitySearch>> onAccuCitySearch = oneIAccuWeatherApi.getCitySearch(tempCitySearchText);
