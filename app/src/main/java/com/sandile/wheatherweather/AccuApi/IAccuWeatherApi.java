...
public interface IAccuWeatherApi {//Responsible for returning call object
    ...
    @GET("forecasts/v1/daily/5day/{cityKey}?apikey=dJ0Bi5PQHmNVyJo15ncVUyABOibyrM73&metric=true")
    ...
    @GET("locations/v1/cities/search?apikey=dJ0Bi5PQHmNVyJo15ncVUyABOibyrM73")
    ...
    @GET("locations/v1/cities/geoposition/search?apikey=dJ0Bi5PQHmNVyJo15ncVUyABOibyrM73&")
